...
#mypersonalConfigs
  alias nas="ssh 192.168.100.235"                                                                        
  alias general="cd /mnt/nfs/general"                                                                   
  alias personal="cd /mnt/nfs/personal"                                                                   
  alias pcharm="/home/sesquivels/mnt/sata/apps/pcharm/bin/pycharm.sh"                                    
  alias exit="history -c && exit"                                                                        
  alias df="df -h | grep -v snap | grep -v tmpfs"                                                        
  alias pic="kitty +kitten icat "                                                                        
  alias setZshrc="nvim ~/.zshrc"                                                                         
  alias vi="nvim"                                                                                        
